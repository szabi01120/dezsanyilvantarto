...
export default function InventoryTable({ inventory, onRefresh, onDelete, showLowStockWarning = false }) {
          ...
          <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-gray-800 border-gray-600">
            <div className="mt-3 text-center">
              ...
              <p className="text-sm text-gray-400 mt-2">
                Biztosan törölni szeretnéd a <strong className="text-white">{showDeleteConfirm.product_name}</strong> terméket?
                <br />
                <span className="text-red-400 font-medium">Ez törli az összes kapcsolódó mozgást is!</span>
                <br />
                <span className="text-red-400 font-medium">Ez a művelet nem visszavonható!</span>
              </p>
